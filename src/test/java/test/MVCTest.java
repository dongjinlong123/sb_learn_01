...
public class MVCTest {
    ...
    public void testResult() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/query.do")// 调用接口
    ...
    public void testGet() throws Exception {
        RequestBuilder request = post("/query.do").contentType(MediaType.APPLICATION_JSON_UTF8).param("name", "董锦龙")
    ...
    public void testPost() throws Exception {
        ...
        RequestBuilder request = post("/query.do").contentType(MediaType.APPLICATION_JSON)
